        ...
        <section class="text-gray-600 body-font relative">
            <div class="absolute inset-0 bg-gray-300">
                <iframe 
                    ...
                    style={{filter: "grayscale(0.2) contrast(1.2) opacity(0.8);"}}></iframe>
            </div>
...
>>>>>>> 97d2ac0 (added responsiveness to card)
                        <h2 class="text-gray-900 text-lg mb-1 pr-2 font-medium title-font">Location:</h2>
                        <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">1298 Park Ave, New York, NY 10201</h2>
                    </div>
                <div class="relative">
<<<<<<< HEAD
                    <label for="email" class="text-gray-600">Food Request Type: Ice Cream</label>
                
                </div>
                <div class="flex relative mb-2 justify-between">
                    <label for="message" class="text-gray-600">Count: 34</label>
                    <label for="message" class="text-right text-gray-600">Expiry Time: 2 Hrs</label>
=======
                  <div class="flex flex-row ">
                     <label for="email" class="text-gray-600 mr-1">Food Type:</label>
                     <label for="email" class="text-gray-600 sm:ml-5">Ice Cream</label>
                  </div>
                </div>
                <div class="flex flex-col md:flex-row relative mb-2 md:justify-between ">
                    <label for="message" class="text-gray-600">Count: 34</label>
                    <label for="message" class=" sm:text-left md:text-right lg:text-right text-gray-600">Expiry Time: 2 Hrs</label>
>>>>>>> 97d2ac0 (added responsiveness to card)
                </div>
                <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Acknowledge</button>
